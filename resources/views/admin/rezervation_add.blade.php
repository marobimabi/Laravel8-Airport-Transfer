                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col-6 form-group">
                                                            <select name="from_location_id"  class="custom-select px-4" style="height: 50px;">
                                                                ...
                                                                @foreach($dataList as  $rs)
                                                                    <option  value="{{$rs->id}}">{{$rs->name}} : {{$rs->lat}} , {{$rs->long}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-6 form-group">
                                                            <select name="to_location_id" class="custom-select px-4" style="height: 50px;">
                                                                <option value="0">Drop Location</option>
                                                                @foreach($dataList as $rs)
                                            ...
                                            <div class="col-lg-4">
                                                <div class="bg-secondary p-5 mb-5" style="margin-top: 200px">
                                                    ...
                                                    <button type="submit" class="btn btn-block btn-primary py-3">Achieve Your Rezervation </button>
