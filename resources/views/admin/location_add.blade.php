                ...
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{route('admin_location_store')}}" method="post"
                                ...
                                <select id="heard" class="form-control" name="type">
                                    <option selected="selected">Airport</option>
                                    <option>City</option>
                                </select>
                                <br/>
                                ...
                                <input type="text" id="fullname" class="form-control" name="long"/>
                                ...
                                <button class="btn btn-primary"><span>Add Location</span></button>
                            </form>
