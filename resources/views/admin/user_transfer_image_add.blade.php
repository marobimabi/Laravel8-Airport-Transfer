            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                                ...
                                <form  action="{{route('user_image_store', ['transfer_id'=>$data->id])}}" method="post" enctype="multipart/form-data" >
                                  @csrf
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                            ...
                            @foreach($images as $rs)
                                <tr>
                                    ...
                                    <td><a href="{{route('user_image_delete', ['id'=> $rs->id,'transfer_id'=>$data->id])}}" onclick="return confirm('Delete ! Are You Sire?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
